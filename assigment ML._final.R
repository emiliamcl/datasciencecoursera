...
str(db_testing)
dim(db_testing)
#20 160  - 20/19622=0,10% for testing -???  use bd_training 70% to train 30% to test the model
names(db_training)
summary(db_testing)
...
#\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\Random Forest w/ cross validation - accuracy 0.9884  ////////////////
...
#Neg Pred Value         0.9969   0.9962   0.9936   0.9988
1.0000
...
#######Predit with the  coursera test data######
