...
trainx <- read.table("file:///.../UCI HAR Dataset_assigment_gettingcleaningdata/train/X_train.txt")
...
testy <- read.table("file:///.../UCI HAR Dataset_assigment_gettingcleaningdata/test/Y_test.txt",col.names=c("activity_ID"))
